...
def fsbid_legs_to_talentmap_legs(data):
    ...
    res = {
        ...
        "todOtherText": pydash.get(data, "ailtodothertext", None),
        "todShortDesc": pydash.get(data, "todshortdesc", None),
        "todLongDesc": pydash.get(data, "toddesctext", None),
...
def fsbid_aia_to_talentmap_aia(data):
    return {
        ...
        "todOtherText": pydash.get(data, "asgdtodothertext", None),
        "todShortDesc": pydash.get(data, "todshortdesc", None),
        "todLongDesc": pydash.get(data, "toddesctext", None),
