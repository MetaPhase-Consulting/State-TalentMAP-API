...
def validate_individual_leg(leg):
    ...
    # Leg - must have TED, if not separation, or if TOD is indefinite or N/A
    if not leg['ted'] and not leg.get('is_separation') and not leg['tod'] == 'Y' and not leg['tod'] == 'Z' or False:
