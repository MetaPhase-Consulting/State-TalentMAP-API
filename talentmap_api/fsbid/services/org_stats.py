...
def org_stats_res_mapping(data):
    ...
    def list_org_stats_map(x):
        return {
            ...
            'total_pos': x.get('ORG_TTL_POS_QTY', 0),
            'total_filled': x.get('ORG_FILLED_POS_QTY', 0),
            'total_percent': x.get('ORG_FILLED_POS_PCT', 0),
            'overseas_pos': x.get('ORG_TTL_POS_OVRS_QTY', 0),
            'overseas_filled': x.get('ORG_FILLED_POS_OVRS_QTY', 0),
            'overseas_percent': x.get('ORG_FILLED_POS_OVRS_PCT', 0),
            'domestic_pos': x.get('ORG_TTL_POS_DMSTC_QTY', 0),
            'domestic_filled': x.get('ORG_FILLED_POS_DMSTC_QTY', 0),
            'domestic_percent': x.get('ORG_FILLED_POS_DMSTC_PCT', 0),
            'total_bids': x.get('ORG_TTL_BIDS_QTY', 0),
            'total_bidders': x.get('ORG_TTL_BIDDERS_QTY', 0),
        }
    ...
    def list_bureau_stats_map(x):
        return {
            ...
            'bureau_code': x.get('BUREAU_CODE'),
            'bureau_short_desc': x.get('BUR_SHORT_DESC'),
            'total_pos': x.get('BUR_TTL_POS_QTY', 0),
            'total_filled': x.get('BUR_FILLED_POS_QTY', 0),
            'total_percent': round((x.get('BUR_FILLED_POS_QTY')/x.get('BUR_TTL_POS_QTY'))) if x.get('BUR_TTL_POS_QTY') else 0,
            'overseas_pos': x.get('BUR_TTL_POS_OVRS_QTY', 0),
            'overseas_filled': x.get('BUR_FILLED_POS_OVRS_QTY', 0),
            'overseas_percent': round((x.get('BUR_FILLED_POS_OVRS_QTY')/x.get('BUR_TTL_POS_OVRS_QTY'))) if x.get('BUR_TTL_POS_OVRS_QTY') else 0,
            'domestic_pos': x.get('BUR_TTL_POS_DMSTC_QTY', 0),
            'domestic_filled': x.get('BUR_FILLED_POS_DMSTC_QTY', 0),
            'domestic_percent': round((x.get('BUR_FILLED_POS_DMSTC_QTY')/x.get('BUR_TTL_POS_DMSTC_QTY'))) if x.get('BUR_TTL_POS_DMSTC_QTY') else 0,
            'org_count': x.get('ORG_COUNT', 0),
            'total_bids_qty': x.get('BUR_TTL_BIDS_QTY', 0),
            'total_bidders_qty': x.get('BUR_TTL_BIDDERS_QTY', 0),
        }
