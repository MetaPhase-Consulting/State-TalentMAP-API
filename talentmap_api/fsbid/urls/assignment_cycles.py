...
urlpatterns = [
    ...
    url(r'^position/(?P<pk>[0-9]+)/$', views.FSBidCyclePositionView.as_view(), name="FSBid-cycle-position"),
    url(r'^position/update/$', views.FSBidCyclePositionUpdateView.as_view(), name="FSBid-cycle-positions"),
