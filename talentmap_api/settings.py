...
PV_API_URL = get_delineated_environment_variable('PV_API_V2_URL', 'http://mock_fsbid:3333/v1/futureVacancies')
PV_API_V2_URL = get_delineated_environment_variable('PV_API_V2_URL', 'http://mock_fsbid:3333/v2/futureVacancies')
PV_API_V3_URL = get_delineated_environment_variable('PV_API_V2_URL', 'http://mock_fsbid:3333/v3/futureVacancies')
